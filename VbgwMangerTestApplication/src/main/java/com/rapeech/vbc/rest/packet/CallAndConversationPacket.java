...
public class CallAndConversationPacket {
    ...
    //230614 : tr_id 관련해서 추가
    private String tr_id;//트랜잭션 아이디

    private boolean isWarning; //이상징후 알람 필드
    private String isWarngingChar;
